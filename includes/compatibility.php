...
class BP_Registration_Compatibility {
	...
	public function __construct() {
		...
		if ( ! empty( $jfb_name ) ) {
			add_action( 'wpfb_inserted_user', [ $this, 'wp_fb_autoconnect_compat' ] );
		}
		...
		add_filter( 'bp_docs_map_meta_caps', [ $this, 'bp_docs_map_meta_caps' ], 100, 4 );
	}
	...
	public function wp_fb_autoconnect_compat( $fbuser ) {
		...
		bp_registration_options_send_admin_email(
			[
				...
				'message'    => sprintf(
					/* translators: placeholders will have user information and a link to the member request page. */
